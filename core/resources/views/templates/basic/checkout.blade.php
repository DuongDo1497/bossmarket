                  ...
                  <form action="{{ route('user.checkout-to-payment', 1) }}" method="post" class="billing-form mb--20">
                    ...
                    <div class="row">
                        ...
                        <div class="billing-select">
                          <select name="shipping_method" class="select-bar false px-2" required>
                            ...
                            @foreach ($shipping_methods as $sm)
                              <option data-shipping="{{ $sm->description }}" data-charge="{{ $sm->charge }}"
                                value="{{ $sm->id }}">@lang($sm->name)</option>
                            @endforeach
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="col-lg-6 mb-20">
                        ...
                        <input class="form-control custom--style" id="fname" type="text" name="firstname"
                          value="{{ auth()->user()->firstname ?? old('firstname') }}" required>
                      </div>
                      <div class="col-lg-6 mb-20">
                        <label for="lname" class="billing-label">@lang('Last Name')</label>
                        <input class="form-control custom--style" id="lname" name="lastname" type="text"
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="mobile" id="mobile"
                            value="{{ old('mobile') ?? auth()->user()->mobile }}" class="form-control custom--style"
                      ...
                      <div class="col-lg-6 mb-20">
                        ...
                        <input class="form-control custom--style" id="email" name="email" type="text"
                      ...
                      <div class="col-md-6 mb-20">
                        ...
                        <input class="form-control custom--style" id="city" name="city" type="text"
                          value="{{ auth()->user()->address->city ?? old('city') }}" required>
                      </div>

                      <div class="col-md-6 mb-20">
                        <label for="state" class="billing-label">@lang('State')</label>
                        <input class="form-control custom--style" id="state" name="state" type="text"
                          value="{{ auth()->user()->address->state ?? old('state') }}" required>
                      </div>

                      <div class="col-md-6 mb-20">
                        <label for="zip" class="billing-label">@lang('Zip/Post Code')</label>
                        <input class="form-control custom--style" id="zip" name="zip" type="text"
                          value="{{ auth()->user()->address->zip ?? old('zip') }}" required>
                      </div>
                  ...
                  <form action="{{ route('user.checkout-to-payment', 2) }}" method="post" class="guest-form mb--20">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6 mb-20">
                        ...
                        <input class="form-control custom--style" id="firstname" type="text" name="firstname"
                          value="{{ old('firstname') }}" required>
                      </div>
                      <div class="col-lg-6 mb-20">
                        <label for="lastname" class="billing-label">@lang('Last Name')</label>
                        <input class="form-control custom--style" id="lastname" name="lastname" type="text"
                      ...
                      <div class="col-lg-6 mb-20">
                        <label for="mobile" class="billing-label">@lang('Mobile')</label>
                        <input class="form-control custom--style" id="mobile" name="mobile" type="text"
                          value="{{ old('mobile') }}" required>
                      </div>

                      <div class="col-lg-6 mb-20">
                        <label for="e-mail" class="billing-label">@lang('Email')</label>
                        <input class="form-control custom--style" id="e-mail" name="email" type="text"
                          required>
                      </div>
                      ...
                      <div class="col-md-6 mb-20">
                        ...
                        <input class="form-control custom--style" id="city-2" name="city" type="text"
                          value="{{ old('city') }}" required>
                      </div>

                      <div class="col-md-6 mb-20">
                        <label for="state-2" class="billing-label">@lang('State')</label>
                        <input class="form-control custom--style" id="state-2" name="state" type="text"
                          value="{{ old('state') }}" required>
                      </div>

                      <div class="col-md-6 mb-20">
                        <label for="zip-2" class="billing-label">@lang('Zip/Post Code')</label>
                        <input class="form-control custom--style" id="zip-2" name="zip" type="text"
  ...
  <script>
    ...
    (function($) {
      ...
      $('select[name=country]').val(
        "{{ isset(auth()->user()->address->country) ? auth()->user()->address->country : '' }}");
