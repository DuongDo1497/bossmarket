        ...
        <div class="col-lg-6">
          ...
          <form class="contact-form row" action="" method="POST">
            ...
            <div class="form-group col-sm-6">
              ...
              <input type="text" class="form-control form--control-2 text--title" name="name" id="name"required
                value="{{ old('') }}">
            </div>
            <div class="form-group col-sm-6">
              <label for="email" class="custom--label text--title">@lang('Your Email')</label>
              <input type="email" class="form-control form--control-2 text--title" name="email" id="email"
                required value="{{ old('') }}">
            </div>
            <div class="form-group col-sm-12">
              <label for="email" class="custom--label text--title">@lang('Subject')</label>
              <input type="text" class="form-control form--control-2 text--title" name="subject" required
                value="{{ old('') }}">
            </div>
            <div class="form-group col-sm-12">
        ...
        <div class="contact--information">
          <div class="info__item">
            ...
            <div class="info__content">
              <span class="info__subtitle">@lang('Phone')</span>
          ...
          <div class="info__item">
            ...
            <div class="info__content">
              <span class="info__subtitle">@lang('Email')</span>
              <h6 class="info__title">
