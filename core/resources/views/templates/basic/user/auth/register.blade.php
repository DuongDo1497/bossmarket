...
@section('content')
  ...
  <section class="account-section padding-bottom padding-top">
    <div class="contact-thumb rev-side d-none d-lg-block">
      <img src="{{ getImage('assets/images/frontend/register_page/' . @$register_content->data_values->image, '650x980') }}"
        alt="register-bg">
    </div>
        ...
        <div class="col-lg-7 offset-lg-5">
          ...
          <form action="{{ route('user.register') }}" method="POST" onsubmit="return submitUserForm();">
            ...
            <div class="contact-group">
              ...
              <input id="email" type="email" class=" checkUser" name="email" value="{{ old('email') }}"
                required>
            </div>
            ...
            <div class="contact-group">
              ...
              <div class="multi-group">
                <input id="username" type="text" class="checkUser w-100" name="username"
            ...
            <div class="contact-group">
              ...
              <div class="multi-group">
                <input id="password-confirm" class="w-100" type="password" name="password_confirmation" required
                  ...
                  <div class="form-check form--check w-100">
                    ...
                    <label for="agree" class="form-check-label">
                      ...
                      @foreach ($pages as $item)
                        <span>
                          <a href="{{ route('page.details', [$item->id, slug($item->data_values->pageTitle)]) }}"
                            class="text--base">{{ __($item->data_values->pageTitle) }}</a>
                          @if (!$loop->last)
                            ,
                          @endif
                        </span>
            ...
            <div class="contact-group">
              <div class="m--10 d-flex flex-wrap align-items-center w-100 justify-content-between">
                <span class="account-alt">@lang('Already have an account?') <a
                    href="{{ route('user.login') }}">@lang('Login')</a></span>
