...
@section('content')
  ...
  <section class="account-section padding-bottom padding-top">
    <div class="contact-thumb rev-side d-none d-lg-block">
      <img
        src="{{ getImage('assets/images/frontend/seller_register_page/' . @$register_content->data_values->image, '650x980') }}"
        alt="register-bg">
    </div>
      ...
      <div class="row">
        <div class="col-lg-7 offset-lg-5">
          ...
          <div class="section-header left-style">
            <h3 class="title">@lang(__(@$register_content->data_values->title))</h3>
            ...
            <div class="contact-group">
              <div class="m--10 d-flex flex-wrap align-items-center w-100 justify-content-between">
                <span class="account-alt">@lang('Already have an account?') <a
                    href="{{ route('seller.login') }}">@lang('Login')</a></span>
