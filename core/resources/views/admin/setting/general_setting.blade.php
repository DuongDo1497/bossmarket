        ...
        <div class="card-body">
          <form action="" method="POST">
            ...
            <div class="row">
                ...
                <div class="form-group">
                  ...
                  <select class="select2-basic" name="timezone">
                    @foreach ($timezones as $timezone)
                      <option value="'{{ @$timezone }}'" @if (config('app.timezone') == $timezone) selected @endif>
                        {{ __($timezone) }}</option>
                    @endforeach
                  </select>
                </div>
              ...
              <div class="col-lg-3">
                <label class="form-control-label font-weight-bold" data-toggle="tooltip" title="@lang("Admin will get the commission from the sale of sellers' products.")">
                  @lang('Commission on Sale') </label>
                <div class="form-group input-group">
                  <input class="form-control form-control-lg" type="text" name="product_commission"
                    value="{{ $general->product_commission }}" required>
              ...
              <div class="col-lg-3 col-sm-6">
                <div class="form-group">
                  <label class="form-control-label font-weight-bold">@lang('Cash On Delivery')</label>
                  <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                    data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Enable')" data-off="@lang('Disable')"
                    name="cod" @if ($general->cod) checked @endif>
                </div>
              </div>
              ...
              <div class="col-lg-3 col-sm-6">
                <div class="form-group">
                  ...
                  <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                    ...
                    data-off="@lang('Disabled')" name="secure_password" @if ($general->secure_password) checked @endif>
                </div>
              </div>
              ...
              <div class="col-lg-3 col-sm-6">
                <div class="form-group">
                  ...
                  <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                    data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Enable')"
                    data-off="@lang('Disabled')" name="registration" @if ($general->registration) checked @endif>
                </div>
              </div>
              ...
              <div class="col-lg-3 col-sm-6">
                <div class="form-group">
                  ...
                  <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                    data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Enable')"
                    data-off="@lang('Disabled')" name="force_ssl" @if ($general->force_ssl) checked @endif>
                </div>
              </div>
              ...
              <div class="col-lg-3 col-sm-6">
                <div class="form-group">
                  ...
                  <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                    data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Enable')"
                    data-off="@lang('Disable')" name="ev" @if ($general->ev) checked @endif>
                </div>
              </div>
              ...
              <div class="col-lg-3 col-sm-6">
                <div class="form-group">
                  ...
                  <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                    data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Enable')"
                    data-off="@lang('Disable')" name="en" @if ($general->en) checked @endif>
                </div>
              </div>
              ...
              <div class="col-lg-3 col-sm-6">
                <div class="form-group">
                  ...
                  <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                    data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Enable')"
                    data-off="@lang('Disable')" name="sv" @if ($general->sv) checked @endif>
                </div>
              </div>
              ...
              <div class="col-lg-3 col-sm-6">
                <div class="form-group">
                  ...
                  <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                    data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Enable')"
                    data-off="@lang('Disable')" name="sn" @if ($general->sn) checked @endif>
                </div>
              </div>
            </div>
