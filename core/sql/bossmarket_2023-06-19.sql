...
--
-- Host: localhost    Database: bossmarket
-- ------------------------------------------------------
...
INSERT INTO `admins` VALUES (1,'Super Admin','admin@bossmarket.vn','admin',NULL,'5ff1c3531ed3f1609679699.jpg','$2y$10$56foedZScyjHjkHvLv54Weh8t2gFPNAWdr/KKAgyZ5JwwqadxOjqS',NULL,'2021-05-07 07:54:06');
...
--
-- Dumping data for table `assign_product_attributes`
--

LOCK TABLES `assign_product_attributes` WRITE;
/*!40000 ALTER TABLE `assign_product_attributes` DISABLE KEYS */;
/*!40000 ALTER TABLE `assign_product_attributes` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `coupons_categories` (
  ...
  CONSTRAINT `coupons_categories_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE,
  CONSTRAINT `coupons_categories_coupon_id_foreign` FOREIGN KEY (`coupon_id`) REFERENCES `coupons` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `coupons_categories`
--
...
CREATE TABLE `coupons_products` (
  ...
  CONSTRAINT `coupons_products_coupon_id_foreign` FOREIGN KEY (`coupon_id`) REFERENCES `coupons` (`id`) ON DELETE CASCADE,
  CONSTRAINT `coupons_products_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `offers_products` (
  ...
  CONSTRAINT `offers_products_offer_id_foreign` FOREIGN KEY (`offer_id`) REFERENCES `offers` (`id`) ON DELETE CASCADE,
  CONSTRAINT `offers_products_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `product_attributes` (
  ...
  `name_for_user` varchar(100) NOT NULL,
...
LOCK TABLES `sell_logs` WRITE;
/*!40000 ALTER TABLE `sell_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `sell_logs` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `seller_logins`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `seller_logins` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `seller_id` int(10) unsigned NOT NULL DEFAULT 0,
  `seller_ip` varchar(40) DEFAULT NULL,
...
--
-- Dumping data for table `seller_logins`
--

LOCK TABLES `seller_logins` WRITE;
/*!40000 ALTER TABLE `seller_logins` DISABLE KEYS */;
/*!40000 ALTER TABLE `seller_logins` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `seller_password_resets`
--

LOCK TABLES `seller_password_resets` WRITE;
/*!40000 ALTER TABLE `seller_password_resets` DISABLE KEYS */;
/*!40000 ALTER TABLE `seller_password_resets` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-06-19 16:05:50
